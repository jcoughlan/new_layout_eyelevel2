...
//    if (cell == nil)
//    {
//        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:@"mapViewAutoCompleteCell"];
//    }
//    
...
//        if( !pinView )
//        {
//            pinView = [[MKAnnotationView alloc] initWithAnnotation:annotation reuseIdentifier:@"mapViewAnnotation"];
//        }
//        
//        
//        pinView.annotation = annotation;
